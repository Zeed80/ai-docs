...
- `AGENT_EMPLOYEE_EXECUTION_PLAYBOOK.md` — подробный план передачи реализации другой модели: карточки E00–E52, ограничения, проверки и review gates. E00 прошла реализацию и code review; следующая карточка E01 — UI текущей сверки.
