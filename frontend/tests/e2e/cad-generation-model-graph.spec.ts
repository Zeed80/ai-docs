...
const graph = {
  ...
  graph: {
    nodes: [{ id: "product:part", type: "Product", name: "Проблемный вал" }],
    edges: [],
    assertions: [{
      id: "assertion:hole-location",
      subject_id: "product:part",
    ...
    evidence: [{ id: "evidence:whole-sheet", kind: "raster_region", source_region_id: "region:whole-sheet", payload: { bbox: [0, 0, 100, 100], fallback: true } }],
    hypothesis_sets: [],
    build_targets: [{ id: "preview", kind: "preview_brep", root_node_ids: ["product:part"], requirement_ids: [], critical_impacts: ["connection_opening"], mass_tolerance_percent: 0 }],
