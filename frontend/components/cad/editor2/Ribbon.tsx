 ...
 * тулбара. Фаза 0 — только каркас: вкладки переключаются, но реальные
 * инструменты появляются по мере фаз плана (Фичи — Ф2/Ф3, Эскиз — Ф4,
 * Тело — позже). "Проверка" получает содержимое первой (Ф1), когда в неё
 * переезжают действия пересборки/приёмки/экспорта из верхней строки. */
