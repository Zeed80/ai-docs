...
// of what a person doing real geometry work needs. Matches /cad/<id>/editor
// exactly (not /cad or /cad/<id> — those keep the normal chrome; only the
// dedicated editor route goes full-screen).
