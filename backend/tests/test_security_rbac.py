...
AGENT_CP_MUTATING = [
    ("POST", "/api/agent/control-plane/config/proposals",
     {"setting_path": "agent_name", "proposed_value": "Test", "reason": "test"}),
    ("POST", "/api/agent/control-plane/config/propose",
     {"setting_path": "agent_name", "proposed_value": "Test", "reason": "test"}),
    ("POST", "/api/agent/control-plane/tasks",
     {"objective": "test", "role": "analyst"}),
    ("POST", "/api/agent/control-plane/tasks/create",
     {"objective": "test", "role": "analyst"}),
    ("POST", "/api/agent/control-plane/teams",
     {"name": "team", "purpose": "test"}),
    ("POST", "/api/agent/control-plane/cron",
     {"schedule": "0 9 * * 1", "prompt": "check", "description": "daily"}),
    ("POST", "/api/agent/control-plane/plugins",
     {"plugin_key": "test_plugin", "name": "Test", "version": "1.0",
      "description": "test", "manifest": {}, "risk_level": "low",
      "installed_by": "test"}),
    ("POST", "/api/agent/control-plane/capabilities",
     {"title": "test cap", "missing_capability": "test",
      "reason": "test", "suggested_artifact": {}}),
    ("POST", "/api/agent/control-plane/capabilities/propose",
     {"title": "test cap", "missing_capability": "test",
      "reason": "test", "suggested_artifact": {}}),
]
