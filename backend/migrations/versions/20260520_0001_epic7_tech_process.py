...
def upgrade() -> None:
    ...
    op.add_column(
        "manufacturing_process_plans",
        sa.Column("drawing_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("drawings.id"), nullable=True),
    )
    op.add_column(
        "manufacturing_process_plans",
        sa.Column("blank_spec_id", postgresql.UUID(as_uuid=True), nullable=True),
    )
    op.add_column(
        "manufacturing_process_plans",
        sa.Column("normcontrol_status", sa.String(30), nullable=False, server_default="not_checked"),
    )
    op.add_column(
        "manufacturing_process_plans",
    ...
    op.add_column(
        "manufacturing_process_plans",
        sa.Column("total_norm_minutes", sa.Float(), nullable=True),
    )
    op.create_index(
        "ix_mfg_process_plans_tp_type",
        "manufacturing_process_plans",
        ["tp_type"],
    )
    op.create_index(
        "ix_mfg_process_plans_drawing_id",
        "manufacturing_process_plans",
        ["drawing_id"],
    )
    op.create_index(
        "ix_mfg_process_plans_normcontrol_status",
        "manufacturing_process_plans",
        ["normcontrol_status"],
    )
    ...
    for col in [
        sa.Column("gost_operation_code", sa.String(10), nullable=True),
        sa.Column("department_code", sa.String(20), nullable=True),
        sa.Column("workplace_code", sa.String(20), nullable=True),
        ...
        sa.Column("to_minutes", sa.Float(), nullable=True),
        sa.Column("tv_minutes", sa.Float(), nullable=True),
        sa.Column("tob_minutes", sa.Float(), nullable=True),
        sa.Column("totd_minutes", sa.Float(), nullable=True),
        sa.Column("tsht_minutes", sa.Float(), nullable=True),
        sa.Column("tsht_k_minutes", sa.Float(), nullable=True),
        sa.Column("tpz_minutes", sa.Float(), nullable=True),
    ]:
