...
def upgrade() -> None:
    ...
    if "engineering_projects" not in tables:
        ...
        op.create_index(
            "ix_engineering_projects_project_id", "engineering_projects", ["project_id"]
        )
    ...
    if "engineering_revisions" not in tables:
        ...
        op.create_index(
            "ix_engineering_revisions_engineering_project_id",
            "engineering_revisions",
            ["engineering_project_id"],
        )
        ...
        op.create_index(
            ...
            "engineering_revisions",
            ["engineering_project_id", "revision"],
            unique=True,
        )
    if "engineering_projections" not in tables:
        ...
        op.create_index(
            "ix_engineering_projections_engineering_revision_id",
            "engineering_projections",
            ["engineering_revision_id"],
        )
        op.create_index(
            "ix_engineering_projections_projection_type",
            "engineering_projections",
            ["projection_type"],
        )
        op.create_index(
            "ix_engineering_projections_entity_type", "engineering_projections", ["entity_type"]
        )
        op.create_index(
            "ix_engineering_projections_entity_id", "engineering_projections", ["entity_id"]
        )
        op.create_index("ix_engineering_projections_state", "engineering_projections", ["state"])
        op.create_index(
            "ix_engineering_projection_target",
            "engineering_projections",
...
def downgrade() -> None:
    op.drop_index(
        "ix_manufacturing_process_plans_engineering_revision_id",
