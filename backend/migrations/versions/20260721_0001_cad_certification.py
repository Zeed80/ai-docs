...
def upgrade() -> None:
    ...
    if "cad_element_records" not in tables:
        op.create_table(
            ...
            sa.Column(
                "cad_ir_revision_id", GUID(), sa.ForeignKey("cad_ir_revisions.id"), nullable=False
            ),
        ...
        op.create_index(
            "ix_cad_element_records_cad_ir_revision_id",
            "cad_element_records",
            ["cad_ir_revision_id"],
        )
        op.create_index(
            "ix_cad_element_records_element_type", "cad_element_records", ["element_type"]
        )
        op.create_index("ix_cad_element_records_assurance", "cad_element_records", ["assurance"])
        op.create_index(
            "ix_cad_element_records_revision_element",
            "cad_element_records",
            ["cad_ir_revision_id", "element_id"],
            unique=True,
        )
    if "cad_relation_records" not in tables:
        ...
        op.create_index(
            "ix_cad_relation_records_cad_ir_revision_id",
            "cad_relation_records",
            ["cad_ir_revision_id"],
        )
        op.create_index(
            "ix_cad_relation_records_relation_type", "cad_relation_records", ["relation_type"]
        )
        op.create_index(
            "ix_cad_relation_records_revision_relation",
            "cad_relation_records",
            ["cad_ir_revision_id", "relation_id"],
            unique=True,
        )
    if "cad_certifications" not in tables:
        op.create_table(
            ...
            sa.Column(
                "cad_ir_revision_id",
                GUID(),
                sa.ForeignKey("cad_ir_revisions.id"),
                nullable=False,
                unique=True,
            ),
        ...
        op.create_index(
            "ix_cad_certifications_cad_ir_revision_id",
            "cad_certifications",
            ["cad_ir_revision_id"],
            unique=True,
        )
