...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_engineering_analysis_cases_engineering_revision_id",
        "engineering_analysis_cases",
        ["engineering_revision_id"],
    )
    op.create_index(
        "ix_engineering_analysis_cases_material_id", "engineering_analysis_cases", ["material_id"]
    )
    op.create_index(
        "ix_engineering_analysis_cases_status", "engineering_analysis_cases", ["status"]
    )
