...
def upgrade() -> None:
    op.create_table(
        "engineering_graph_revisions", *_timestamps(),
        ...
        sa.Column("comprehension_status", sa.String(30), nullable=False, server_default="accumulating"),
    ...
    op.create_index("ix_engineering_graph_revisions_engineering_project_id", "engineering_graph_revisions", ["engineering_project_id"])
    op.create_index("ix_engineering_graph_revisions_engineering_revision_id", "engineering_graph_revisions", ["engineering_revision_id"])
    op.create_index("ix_engineering_graph_revisions_graph_id", "engineering_graph_revisions", ["graph_id"])
    op.create_index("ix_emg_graph_revision", "engineering_graph_revisions", ["graph_id", "revision"], unique=True)
    op.create_index("ix_engineering_graph_revisions_profile", "engineering_graph_revisions", ["profile"])
    op.create_index("ix_emg_project_created", "engineering_graph_revisions", ["engineering_project_id", "created_at"])

    op.create_table(
        "graph_patches", *_timestamps(),
        sa.Column("graph_id", sa.String(255), nullable=False),
    ...
    op.create_table(
        "graph_verification_runs", *_timestamps(),
        sa.Column("graph_revision_id", GUID(), sa.ForeignKey("engineering_graph_revisions.id"), nullable=False),
    ...
    op.create_index("ix_graph_verification_runs_graph_revision_id", "graph_verification_runs", ["graph_revision_id"])

    op.create_table(
        "trace_proposals", *_timestamps(),
        sa.Column("graph_revision_id", GUID(), sa.ForeignKey("engineering_graph_revisions.id"), nullable=False),
    ...
    op.create_table(
        "visual_verification_runs", *_timestamps(),
    ...
    op.create_index("ix_visual_verification_runs_trace_proposal_id", "visual_verification_runs", ["trace_proposal_id"])
    op.create_index("ix_visual_verification_runs_verdict", "visual_verification_runs", ["verdict"])

    op.create_table(
        "engineering_graph_nodes", *_timestamps(),
        sa.Column("graph_revision_id", GUID(), sa.ForeignKey("engineering_graph_revisions.id"), nullable=False),
    ...
    op.create_index("ix_engineering_graph_nodes_graph_revision_id", "engineering_graph_nodes", ["graph_revision_id"])
    op.create_index("ix_engineering_graph_nodes_node_type", "engineering_graph_nodes", ["node_type"])

    op.create_table(
        "engineering_graph_edges", *_timestamps(),
        sa.Column("graph_revision_id", GUID(), sa.ForeignKey("engineering_graph_revisions.id"), nullable=False),
    ...
    op.create_table(
        "engineering_graph_assertions", *_timestamps(),
        sa.Column("graph_revision_id", GUID(), sa.ForeignKey("engineering_graph_revisions.id"), nullable=False),
    ...
    for name in ("graph_revision_id", "subject_node_id", "predicate", "origin", "assurance", "state"):
        op.create_index(f"ix_engineering_graph_assertions_{name}", "engineering_graph_assertions", [name])


def downgrade() -> None:
    for table in (
        "engineering_graph_assertions", "engineering_graph_edges", "engineering_graph_nodes",
        "visual_verification_runs", "trace_proposals", "graph_verification_runs",
        "graph_patches", "engineering_graph_revisions",
    ):
        op.drop_table(table)
