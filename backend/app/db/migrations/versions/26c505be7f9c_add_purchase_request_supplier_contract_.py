...
down_revision: str | None = "53cbfc732ca8"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_supplier_contracts_supplier_id"),
        "supplier_contracts",
        ["supplier_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_payment_schedules_due_date"), "payment_schedules", ["due_date"], unique=False
    )
    op.create_index(
        op.f("ix_payment_schedules_invoice_id"), "payment_schedules", ["invoice_id"], unique=False
    )
