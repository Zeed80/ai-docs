...
down_revision: str | None = "d9a1b6e4c230"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_manufacturing_resources_resource_type"),
        "manufacturing_resources",
        ["resource_type"],
    )
    ...
    op.create_index(
        op.f("ix_manufacturing_process_plans_document_id"),
        "manufacturing_process_plans",
        ["document_id"],
    )
    op.create_index(
        op.f("ix_manufacturing_process_plans_bom_id"), "manufacturing_process_plans", ["bom_id"]
    )
    op.create_index(
        op.f("ix_manufacturing_process_plans_product_name"),
        "manufacturing_process_plans",
        ["product_name"],
    )
    op.create_index(
        op.f("ix_manufacturing_process_plans_product_code"),
        "manufacturing_process_plans",
        ["product_code"],
    )
    op.create_index(
        op.f("ix_manufacturing_process_plans_status"), "manufacturing_process_plans", ["status"]
    )
    ...
    op.create_index(
        op.f("ix_manufacturing_operations_process_plan_id"),
        "manufacturing_operations",
        ["process_plan_id"],
    )
    op.create_index(op.f("ix_manufacturing_operations_name"), "manufacturing_operations", ["name"])
    op.create_index(
        op.f("ix_manufacturing_operations_operation_type"),
        "manufacturing_operations",
        ["operation_type"],
    )
    op.create_index(
        op.f("ix_manufacturing_operations_machine_resource_id"),
        "manufacturing_operations",
        ["machine_resource_id"],
    )
    op.create_index(
        op.f("ix_manufacturing_operations_tool_resource_id"),
        "manufacturing_operations",
        ["tool_resource_id"],
    )
    op.create_index(
        op.f("ix_manufacturing_operations_fixture_resource_id"),
        "manufacturing_operations",
        ["fixture_resource_id"],
    )
    ...
    op.create_index(
        op.f("ix_manufacturing_norm_estimates_process_plan_id"),
        "manufacturing_norm_estimates",
        ["process_plan_id"],
    )
    op.create_index(
        op.f("ix_manufacturing_norm_estimates_operation_id"),
        "manufacturing_norm_estimates",
        ["operation_id"],
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_manufacturing_norm_estimates_operation_id"),
        table_name="manufacturing_norm_estimates",
    )
    op.drop_index(
        op.f("ix_manufacturing_norm_estimates_process_plan_id"),
        table_name="manufacturing_norm_estimates",
    ...
    op.drop_index(
        op.f("ix_manufacturing_operations_tool_resource_id"), table_name="manufacturing_operations"
    )
    op.drop_index(
        op.f("ix_manufacturing_operations_machine_resource_id"),
        table_name="manufacturing_operations",
    ...
    op.drop_index(
        op.f("ix_manufacturing_operations_operation_type"), table_name="manufacturing_operations"
    )
    op.drop_index(op.f("ix_manufacturing_operations_name"), table_name="manufacturing_operations")
    op.drop_index(
        op.f("ix_manufacturing_operations_process_plan_id"), table_name="manufacturing_operations"
    )
    op.drop_table("manufacturing_operations")
    op.drop_index(
        op.f("ix_manufacturing_process_plans_status"), table_name="manufacturing_process_plans"
    )
    op.drop_index(
        op.f("ix_manufacturing_process_plans_product_code"),
        table_name="manufacturing_process_plans",
    )
    op.drop_index(
        op.f("ix_manufacturing_process_plans_product_name"),
        table_name="manufacturing_process_plans",
    ...
    op.drop_index(
        op.f("ix_manufacturing_process_plans_bom_id"), table_name="manufacturing_process_plans"
    )
    op.drop_index(
        op.f("ix_manufacturing_process_plans_document_id"), table_name="manufacturing_process_plans"
    )
    ...
    op.drop_index(
        op.f("ix_manufacturing_resources_resource_type"), table_name="manufacturing_resources"
    )
