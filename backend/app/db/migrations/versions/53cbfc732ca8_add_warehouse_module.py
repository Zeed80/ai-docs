...
down_revision: str | None = "b7f3a2c4d891"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_warehouse_receipts_receipt_number", "warehouse_receipts", ["receipt_number"]
    )
    ...
    op.create_index(
        "ix_warehouse_receipt_lines_receipt_id", "warehouse_receipt_lines", ["receipt_id"]
    )
