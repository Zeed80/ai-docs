...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_technology_corrections_entity_type"), "technology_corrections", ["entity_type"]
    )
    op.create_index(
        op.f("ix_technology_corrections_entity_id"), "technology_corrections", ["entity_id"]
    )
    op.create_index(
        op.f("ix_technology_corrections_field_name"), "technology_corrections", ["field_name"]
    )
    op.create_index(
        op.f("ix_technology_corrections_source_document_id"),
        "technology_corrections",
        ["source_document_id"],
    )
    op.create_index(
        op.f("ix_technology_corrections_process_plan_id"),
        "technology_corrections",
        ["process_plan_id"],
    )
    op.create_index(
        op.f("ix_technology_corrections_operation_id"), "technology_corrections", ["operation_id"]
    )


def downgrade() -> None:
    op.drop_index(
        op.f("ix_technology_corrections_operation_id"), table_name="technology_corrections"
    )
    op.drop_index(
        op.f("ix_technology_corrections_process_plan_id"), table_name="technology_corrections"
    )
    op.drop_index(
        op.f("ix_technology_corrections_source_document_id"), table_name="technology_corrections"
    )
    ...
    op.drop_index(
        op.f("ix_technology_corrections_entity_type"), table_name="technology_corrections"
    )
