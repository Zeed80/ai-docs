...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("open", "resolved", "false_positive", "escalated", name="anomalystatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_anomaly_cards_entity_id"), "anomaly_cards", ["entity_id"], unique=False
    )
    op.create_table(
        "approvals",
        sa.Column(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending", "approved", "rejected", "delegated", "expired", name="approvalstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_audit_timeline_events_entity_id"),
        "audit_timeline_events",
        ["entity_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("proposed", "active", "disabled", "rejected", name="normrulestatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_normalization_rules_field_name"),
        "normalization_rules",
        ["field_name"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "needs_review", "approved", "rejected", "paid", name="invoicestatus"),
            nullable=False,
        ),
        sa.Column("overall_confidence", sa.Float(), nullable=True),
        sa.Column("metadata", sa.JSON(), nullable=True),
    ...
    op.create_index(
        op.f("ix_price_history_entries_canonical_item_id"),
        "price_history_entries",
        ["canonical_item_id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_price_history_entries_canonical_item_id"), table_name="price_history_entries"
    )
