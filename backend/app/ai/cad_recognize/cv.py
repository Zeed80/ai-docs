...
# Widened (2026-07-13): the skeleton tracer fragments one drawn circle into
# several arcs whose independently-fitted centres/radii scatter by a few px;
# tight tolerances left them as separate arc fragments instead of rejoining
# the circle. This is the SAFE way to recover circles (only real traced arcs
# merge — no Hough hallucination on window grids/hatching).
_ARC_MERGE_CENTER_TOL_PX = 8.0
_ARC_MERGE_RADIUS_TOL = 0.10  # relative
_FULL_CIRCLE_MIN_SPAN_DEG = 300.0
