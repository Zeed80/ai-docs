...
> Roadmap exploratory-режима WorkOrder, self-learning connector library, idle-reflection
> «подсознание» и тона/характера агента (все 7 фаз завершены) — [`AGENT_AUTONOMY_ROADMAP.md`](./AGENT_AUTONOMY_ROADMAP.md).
